...
class DiscordService {
  ...
  constructor() {
    ...
    this.clientSecret = import.meta.env.VITE_DISCORD_CLIENT_SECRET;
    this.redirectUri = import.meta.env.VITE_DISCORD_REDIRECT_URI;
    ...
    this.apiBase = import.meta.env.VITE_DISCORD_API_BASE;
    this.checkApiBase = import.meta.env.VITE_DISCORD_CHECK_API || 'http://localhost:3000'; // Bot API URL
  ...
  getAuthUrl(): string {
    ...
    const redirectUri = `${currentOrigin}/auth/discord/callback`;
